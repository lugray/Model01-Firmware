...
KEYMAPS(
  [L_PRIMARY] = KEYMAP(
    ...
    Key_Home,     Key_A, Key_S, Key_D, Key_F, Key_G, /**/     /**/          Key_H, Key_J,  Key_K,     Key_L,      TOPSY(Semicolon), Key_Quote,
    Key_End,      Key_Z, Key_X, Key_C, Key_V, Key_B, LAlt,    TOPSY(Minus), Key_N, Key_M,  Key_Comma, Key_Period, Key_Slash,        Key_Minus,
    ...
    Key_PageUp,   WinLeft, WinDown, WinRight, ___,        ___,    /**/             /**/        Key_LeftArrow, Key_DownArrow, Key_UpArrow, Key_RightArrow, Key_Semicolon, TOPSY(Quote),
